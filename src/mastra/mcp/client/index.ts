...
export const mcpClient = new MCPClient({
  servers: {
    'mcp-midscene': {
      ...
      args: ['-y', '@midscene/mcp'],
      env: {
        OPENAI_API_KEY: process.env.VL_OPENAI_API_KEY || '',
        MIDSCENE_MODEL_NAME: process.env.VL_MIDSCENE_MODEL_NAME || '',
        OPENAI_BASE_URL: process.env.VL_OPENAI_BASE_URL || '',
        MIDSCENE_USE_VLM_UI_TARS: process.env.VL_MIDSCENE_USE_VLM_UI_TARS || '',
